...
echo "Building Amplify Frontend v5 with all fixes..."
echo "- Standalone-aware Dockerfile"
...
docker build \
  ...
  -t amplify-frontend:v5-standalone \
  -f Dockerfile.standalone \
  .

echo ""
echo "Build complete! Tagged as v5-standalone"
echo ""
echo "To test locally:"
echo "docker run -p 3000:3000 amplify-frontend:v5-standalone"