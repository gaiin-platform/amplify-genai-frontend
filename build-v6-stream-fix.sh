...
echo "Building Amplify Frontend v6 with SSE stream fix..."
echo "- Added proxy endpoint to convert JSON to SSE"
echo "- Updated chatService to use proxy for LLM router"
echo ""
...
docker build \
  ...
  -t amplify-frontend:v6-stream-fix \
  -f Dockerfile.standalone \
  .

echo ""
echo "Build complete! Tagged as v6-stream-fix"
echo ""
echo "Next steps:"
echo "1. Tag and push: ./push-to-ecr.sh amplify-frontend:v6-stream-fix"
echo "2. Monitor deployment in ECS console"