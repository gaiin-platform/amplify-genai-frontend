...
# Build v21: Based on working v20 build with updated environment variables
# This ensures we use the last known working code configuration

set -e

echo "=== Amplify Frontend Build v21: Based on v20 with Environment Fixes ==="

# First, restore the original next.config.js
...
# Use the same Dockerfile that worked for v20
echo "Using v20 Dockerfile as base..."
cat > Dockerfile << 'EOF'
...
ARG NEXT_PUBLIC_APP_VERSION="1.0.21"
...
RUN echo "# NextAuth Configuration" > .env.production && \
    ...
    echo "NEXT_PUBLIC_LLM_ROUTER_ENDPOINT=https://x18hnd6yh6.execute-api.us-east-1.amazonaws.com/prod/proxy/llm" >> .env.production && \
    echo "" >> .env.production && \
    ...
    echo "NEXT_PUBLIC_APP_VERSION=\"1.0.21\"" >> .env.production
...
docker tag hfu-amplify-frontend:v21 135808927724.dkr.ecr.us-east-1.amazonaws.com/dev-amplifygenai-repo:v21
docker tag hfu-amplify-frontend:v21 135808927724.dkr.ecr.us-east-1.amazonaws.com/dev-amplifygenai-repo:latest

echo ""
echo "=== Build v21 Complete ==="
echo ""
echo "This build includes:"
echo "✓ Working v20 code base (no TypeScript errors)"
echo "✓ Comprehensive environment variables including NEXT_PUBLIC_DEFAULT_AUTH_PROVIDER"
echo "✓ All authentication configuration for Cognito"
echo "✓ Updated version number to v1.0.21"
echo ""
echo "Next steps:"
echo "1. Push to ECR:"
...
echo "   docker push 135808927724.dkr.ecr.us-east-1.amazonaws.com/dev-amplifygenai-repo:v21"
