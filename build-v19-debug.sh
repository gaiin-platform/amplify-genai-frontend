...
echo "Building Amplify Frontend v19 - Debug Build"
echo "Checking auth configuration before build..."
echo ""

# Show the current auth configuration
echo "=== Current [...nextauth].ts content ==="
cat pages/api/auth/[...nextauth].ts | grep -A 20 "providers:"
...
docker build \
  ...
  -t amplify-frontend:v19-debug \
  -f Dockerfile.standalone \
  . 2>&1 | tee build-v19.log

echo ""
echo "Build complete! Tagged as v19-debug"
echo "Check build-v19.log for details"