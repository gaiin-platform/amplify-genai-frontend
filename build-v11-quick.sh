...
echo "Building Amplify Frontend v11 - Quick SSE Fix"
echo "Using debug handler endpoint for better diagnostics"
echo ""
...
docker build \
  ...
  -t amplify-frontend:v11-debug \
  -f Dockerfile.standalone \
  .

echo ""
echo "Build complete! Tagged as v11-debug"