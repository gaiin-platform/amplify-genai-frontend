...
echo "Building Amplify Frontend v8 - Final fix for chat display"
echo "- Force use of proxy endpoint for LLM router"
echo "- Proxy converts JSON to SSE format"
echo ""
...
docker build \
  ...
  -t amplify-frontend:v8-final \
  -f Dockerfile.standalone \
  .

echo ""
echo "Build complete! Tagged as v8-final"