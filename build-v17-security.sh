...
echo "Building Amplify Frontend v17 - Security Headers"
echo "- Added security headers to prevent warnings"
echo "- Includes all v16 fixes"
echo ""
...
docker build \
  ...
  -t amplify-frontend:v17-security \
  -f Dockerfile.standalone \
  .

echo ""
echo "Build complete! Tagged as v17-security"