...
# Build v23: Complete build with all fixes
# - TypeScript errors resolved
# - NextAuth callback fixes in place
# - All environment variables configured

set -e

echo "=== Amplify Frontend Build v23: Complete Fix Package ==="
echo "This build includes all fixes: TypeScript, NextAuth callbacks, and environment variables"
...
NEXT_PUBLIC_APP_VERSION="1.0.23"
...
docker build -t hfu-amplify-frontend:v23 \
  ...
  --build-arg NEXT_PUBLIC_APP_VERSION="1.0.23" \
  .

# Tag for ECR
echo "Tagging for ECR..."
docker tag hfu-amplify-frontend:v23 135808927724.dkr.ecr.us-east-1.amazonaws.com/dev-amplifygenai-repo:v23
docker tag hfu-amplify-frontend:v23 135808927724.dkr.ecr.us-east-1.amazonaws.com/dev-amplifygenai-repo:latest
...
echo "   docker push 135808927724.dkr.ecr.us-east-1.amazonaws.com/dev-amplifygenai-repo:v23"
