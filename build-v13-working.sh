...
echo "Building Amplify Frontend v13 - Working Handler"
echo "- Complete OpenAI-compatible SSE format"
echo "- Ensures no undefined content is sent"
echo "- Includes all required fields"
echo ""
...
docker build \
  ...
  -t amplify-frontend:v13-working \
  -f Dockerfile.standalone \
  .

echo ""
echo "Build complete! Tagged as v13-working"