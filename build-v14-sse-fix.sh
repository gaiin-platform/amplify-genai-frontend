...
echo "Building Amplify Frontend v14 - SSE Content Fix"
echo "- Fixes undefined content handling in SSE parser"
echo "- Adds debug logging for SSE events"
echo "- Prevents silent failures when content is undefined"
echo ""
...
docker build \
  ...
  -t amplify-frontend:v14-sse-fix \
  -f Dockerfile.standalone \
  .

echo ""
echo "Build complete! Tagged as v14-sse-fix"
echo ""
echo "Next steps:"
echo "1. Tag for ECR:"
echo "   docker tag amplify-frontend:v14-sse-fix 135808927724.dkr.ecr.us-east-1.amazonaws.com/dev-amplifygenai-repo:v14-sse-fix"
echo ""
echo "2. Push to ECR:"
echo "   docker push 135808927724.dkr.ecr.us-east-1.amazonaws.com/dev-amplifygenai-repo:v14-sse-fix"
echo ""
