...
const AssistantPage = ({
  ...
  if (loading) {
    return (
      ...
      >
        <div className="flex h-full items-center justify-center bg-brand-light-bg dark:bg-brand-dark-bg">
  ...
  if (error) {
    return (
      <MainLayout
        ...
        showRightSidebar={false}
      >
        <div className="flex h-screen w-screen flex-col items-center justify-center text-center bg-brand-light-bg dark:bg-brand-dark-bg">
  ...
  return (
    ...
    >
      ...
      <div className="bg-brand-light-bg dark:bg-brand-dark-bg border-b border-neutral-200 dark:border-neutral-600 py-4 px-4 relative">
      ...
      {/* Chat messages */}
      <div className="flex-1 overflow-y-auto py-4 px-6 bg-brand-light-bg dark:bg-brand-dark-bg">
                    ...
                    <div className="flex justify-end">
                      <div id={`userMessage${index}`} className="amplify-user-message amplify-message-container">
                        {editing === index ? (
                          <>
                          <textarea
                            className="w-full p-3 border border-neutral-300 dark:border-neutral-600 rounded-lg bg-white bg-brand-light-input dark:bg-brand-dark-input text-neutral-900 dark:text-neutral-100 focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm transition-all resize-none"
                            value={editedContent}
                            id="editUserMessage"
            ...
            {isProcessing && (
              <div className="mb-6">
                <div className="flex justify-start">
                  <div className="bg-neutral-100 bg-brand-light-secondary dark:bg-brand-dark-secondary px-4 py-3 rounded-lg">
      ...
      {/* Input area */}
      <div className="border-t border-neutral-200 dark:border-neutral-600 bg-brand-light-bg dark:bg-brand-dark-bg py-4 px-6">
      
        <div className="w-full px-10">
          <div className="relative">
            <textarea
              ref={textareaRef}
              className="w-full resize-none rounded-lg border border-neutral-300 dark:border-neutral-600 bg-white bg-brand-light-input dark:bg-brand-dark-input px-4 py-3 pr-12 text-neutral-900 dark:text-neutral-100 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-500"
              style={{
                minHeight: '56px',
                maxHeight: '200px',
              }}
