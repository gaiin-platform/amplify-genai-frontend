...
export const UserCostsModal: FC<Props> = ({ open, onClose }) => {
  ...
  // Calculate status based on percentage of limit being used
  ...
  // Check if a billing group is over its rate limit (either daily or monthly)
  ...
  // Get worst-case status across daily/monthly limits for at-a-glance badge
  ...
  // Color-coded styles for each rate limit status
  ...
  // Render status badge (colored pill with icon)
  ...
  // Render rate limit progress bar with percentage display
