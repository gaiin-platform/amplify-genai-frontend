            ...
            <div className="flex flex-row gap-3 mb-2 ">
                ...
                <button title={isAddingFeature.featureData.enabled ? "Click to disabled"        
                    ...
                    className={`mt-1.5 h-[40px] w-[80px] px-1 items-center cursor-pointer
                                bg-gray-200 bg-brand-light-input dark:bg-brand-dark-input ${isAddingFeature.featureData.enabled
                ...
                <div className="ml-4 flex-grow flex flex-col mt-[-32px] max-w-[40%]">
                    ...
                    />
                        <div className="h-[40px] rounded-r border border-neutral-500 pl-4 py-1 bg-brand-light-input dark:bg-brand-dark-input bg-gray-200 dark:text-neutral-100 text-neutral-900 shadow focus:outline-none dark:border-neutral-800 dark:border-opacity-50 overflow-x-auto">
