...
const PromptTextArea: React.FC<PromptTextAreaProps> = ({
    ...
    return (
        <div className="flex flex-col rounded-lg w-full border border-neutral-500 dark:border-neutral-800 dark:border-opacity-50 bg-brand-light-input dark:bg-brand-dark-input">
            ...
            {!codeLanguage && (
                <textarea
                    className="mt-0 mb-0 w-full rounded-t-lg border border-neutral-500 px-4 py-2 text-neutral-900 shadow focus:outline-none dark:border-neutral-800 dark:border-opacity-50 bg-brand-light-input dark:bg-brand-dark-input dark:text-neutral-100"
                    id="textArea"
                    value={textAreaValue}
                ...
                {!isGenerating && (
                    <div className="flex items-center space-x-2">
                        <button
                            ...
                            className="mr-2 w-full px-4 py-2 mt-0 border rounded-b-lg shadow border-neutral-500 text-neutral-900 hover:bg-neutral-100 focus:outline-none dark:border-neutral-800 dark:border-opacity-50 bg-brand-light-input dark:bg-brand-dark-input dark:text-neutral-100"
                        >
