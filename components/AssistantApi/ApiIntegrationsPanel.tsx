...
const ApiIntegrationsPanel: React.FC<ApiIntegrationsPanelProps> = ({
  ...
  `mt-2 mb-4 flex items-center gap-2 rounded border border-neutral-500 px-3 py-2 text-sm text-neutral-800 dark:border-neutral-700 dark:text-neutral-100 whitespace-nowrap ${shown ? "bg-neutral-300 bg-brand-light-input dark:bg-brand-dark-input" : "hover:bg-neutral-200 dark:hover:bg-neutral-700"}`;
