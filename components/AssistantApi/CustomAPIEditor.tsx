    ...
    <div>
      ...
      {apiInfo.map((api, index) => (
        ...
        <div className="mb-4 p-4 border border-gray-300 rounded ">
          ...
          <input
            className="mt-2 mb-2 w-full rounded-lg border border-neutral-500 px-4 py-2 text-neutral-900 shadow focus:outline-none dark:border-neutral-800 dark:border-opacity-50 bg-brand-light-input dark:bg-brand-dark-input dark:text-neutral-100"
            placeholder="Name"
            value={api.name}
            onChange={(e) => {
          ...
          <div className="mt-2">
            ...
            {(api.params || []).map((param, paramIndex) => (
              <div key={paramIndex} className="flex mt-1">
                <input
                  className="w-1/2 mr-2 rounded-lg border border-neutral-500 px-4 py-2 text-neutral-900 shadow focus:outline-none dark:border-neutral-800 dark:border-opacity-50 bg-brand-light-input dark:bg-brand-dark-input dark:text-neutral-100"
                  placeholder="Name"
                  value={param.name}
                  onChange={(e) => {
                    const newApiInfo = [...apiInfo];
                ...
                />
                <input
                  className="w-1/2 rounded-lg border border-neutral-500 px-4 py-2 text-neutral-900 shadow focus:outline-none dark:border-neutral-800 dark:border-opacity-50 bg-brand-light-input dark:bg-brand-dark-input dark:text-neutral-100"
          ...
          <div className="mt-2">
            ...
            <textarea
              className="mt-1 w-full rounded-lg border border-neutral-500 px-4 py-2 text-neutral-900 shadow focus:outline-none dark:border-neutral-800 dark:border-opacity-50 bg-brand-light-input dark:bg-brand-dark-input dark:text-neutral-100"
          ...
          <div className="mt-2">
            ...
            <select
              className="ml-2 rounded-lg border border-neutral-500 px-4 py-2 text-neutral-900 shadow focus:outline-none dark:border-neutral-800 dark:border-opacity-50 bg-brand-light-input dark:bg-brand-dark-input dark:text-neutral-100"
              value={api.auth.type || ""}
              onChange={(e) => {
                const newApiInfo = [...apiInfo];
          ...
          {api.auth.type === 'basic' && (
            <div className="mt-2">
              <input
                className="mr-2 w-1/2 rounded-lg border border-neutral-500 px-4 py-2 text-neutral-900 shadow focus:outline-none dark:border-neutral-800 dark:border-opacity-50 bg-brand-light-input dark:bg-brand-dark-input dark:text-neutral-100"
