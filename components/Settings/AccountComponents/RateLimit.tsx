...
export const RateLimiter: FC<RateLimitProps> = ({period, setPeriod, rate, setRate}) => {
    ...
    return (
            ...
            <select
                id="rateLimitType"
                className="rounded border-gray-300 p-0.5 text-neutral-900 dark:text-neutral-100 shadow-sm bg-brand-light-input dark:bg-brand-dark-input focus:border-neutral-700 focus:ring focus:ring-neutral-500 focus:ring-opacity-50  custom-shadow"
                style={{ width: '92px'}}
                value={period}
