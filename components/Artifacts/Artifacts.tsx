        ...
        <div className="flex flex-col" > 
            ...
            <div className="mt-4 flex justify-center">
                <div className="
                    ...
                    rounded-full bg-white dark:bg-[#343541] shadow-lg
                    border border-gray-200 dark:border-gray-600 h-10 px-6
            ...
            <div className="flex justify-center items-center ">
                <div className="w-full flex flex-row justify-between mr-2">
                    ...
                    <div className="enhanced-chat-icons-vertical h-min mt-8 flex flex-col gap-1 items-center p-1">
                        {isPreviewing ?
                            <button
