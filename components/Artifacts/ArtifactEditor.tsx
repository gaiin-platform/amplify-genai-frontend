...
export const ArtifactEditor: React.FC<Props> = ({
  ...
  return (
    <div className="mt-8 group md:px-4 bg-gray-50 text-gray-800 dark:border-gray-900/50 bg-brand-light-secondary dark:bg-brand-dark-secondary dark:text-gray-100 h-[calc(100vh-140px)] flex flex-col">
