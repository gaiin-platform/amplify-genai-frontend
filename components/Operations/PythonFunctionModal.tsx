        ...
        <div className={`fixed inset-0 flex items-center justify-center ${blackoutBackground ? 'bg-black bg-opacity-50 z-50' : ''}`}>
            <div className="fixed inset-0 z-10 overflow-hidden">
                <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <div
                        className={`text-black dark:text-neutral-200 inline-block overflow-hidden ${blackoutBackground ? 'rounded-lg border border-gray-300 dark:border-neutral-600' : ''} bg-white pt-5 text-left align-bottom shadow-xl transition-all bg-brand-light-modal dark:bg-brand-dark-modal sm:my-8 sm:align-middle`}
                        ref={modalRef}
                        role="dialog"
...
`;
                                ...
                                <input
                                    className="mt-2 w-full rounded-lg border border-neutral-500 px-4 py-2 shadow bg-brand-light-input dark:bg-brand-dark-input dark:text-neutral-100"
                            ...
                            {selectedFnId && (
                              <div className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                ...
                                <div className="mt-4">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <input
                                            ...
                                            className="flex-grow rounded-lg border border-neutral-500 px-3 py-1 bg-brand-light-input dark:bg-brand-dark-input dark:text-neutral-100"
                                            value={newTagInput}
                                ...
                                <div className="mt-6">
                                    ...
                                    {envVars.map((env, index) => (
                                        <div key={index} className="grid grid-cols-3 gap-2 mb-2 items-center">
                                            ...
                                            <select
                                                className="ml-2 border rounded p-2 bg-brand-light-input dark:bg-brand-dark-input dark:text-white"
                                                value={env.type}
                                                onChange={(e) => {
                                            ...
                                            <input
                                                className="border rounded p-2 bg-brand-light-input dark:bg-brand-dark-input dark:text-white"
                                                placeholder="Key"
                                                value={env.key}
                                                onChange={(e) => {
                                                    const newVars = [...envVars];
                                ...
                                <div className="mt-2 grid grid-cols-2 gap-4">
                                    <input
                                        className="col-span-2 rounded-lg border border-neutral-500 px-4 py-2 shadow bg-brand-light-input dark:bg-brand-dark-input dark:text-neutral-100"
                                    ...
                                    />
                                    <textarea
                                        className="col-span-2 rounded-lg border border-neutral-500 px-4 py-2 shadow bg-brand-light-input dark:bg-brand-dark-input dark:text-neutral-100 font-mono"
 ...
 -d '${JSON.stringify({ data: input }, null, 2)}'`;
                                ...
                                <div className="border rounded p-4 space-y-3">
                                    <div>
                                        ...
                                        <input
                                            type="text"
                                            className="w-full border rounded p-2 bg-brand-light-input dark:bg-brand-dark-input dark:text-white"
                        ...
                        <div className="flex flex-row items-center justify-end p-4 bg-white bg-brand-light-modal dark:bg-brand-dark-modal">
                            <button
