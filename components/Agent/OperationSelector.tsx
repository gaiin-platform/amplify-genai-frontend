...
const OperationSelector: React.FC<OperationSelectorProps> = ({
    ...
    return (
        <div className="flex h-[400px] w-full border border-gray-300 dark:border-gray-700 rounded-lg shadow-lg bg-white bg-brand-light-modal dark:bg-brand-dark-modal overflow-hidden">
                    ...
                    <div className="p-6">
                        ...
                        <div className="mb-4">
                            ...
                            <input
                              ...
                              className="w-full px-3 py-2 border rounded-md bg-brand-light-bg dark:bg-brand-dark-bg border-gray-300 dark:border-neutral-600
                        ...
                        <details className="mt-6 bg-brand-light-bg dark:bg-brand-dark-bg border border-gray-300 dark:border-neutral-600 rounded-md">
