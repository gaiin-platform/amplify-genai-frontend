      ...
      <div className="w-1/4 border-r border-neutral-300 dark:border-neutral-700 overflow-y-auto pr-4"
        ...
        !Array.isArray(allTasks) || allTasks.length === 0 ? (
          ...
          <div className="space-y-4">
            ...
            <select 
              className="w-full px-2 py-1 border rounded-lg bg-brand-light-input dark:bg-brand-dark-input dark:border-neutral-600 dark:text-white"
      ...
      case 'assistant':
        ...
        return (
          <div className="flex flex-row gap-2 mb-4">
              <select
                  className={`mt-[-4px] w-full rounded-lg px-4 border py-2 text-neutral-900 shadow focus:outline-none bg-neutral-100 bg-brand-light-input dark:bg-brand-dark-input dark:text-neutral-100 custom-shadow 
        ...
        return (
          <div className="flex flex-col mb-4 relative">
            <div 
              ...
              className={`mt-[-4px] w-full rounded-lg px-4 border py-2 text-neutral-900 shadow focus:outline-none bg-neutral-100 bg-brand-light-input dark:bg-brand-dark-input dark:text-neutral-100 custom-shadow flex justify-between items-center
              ${selectedTask.objectInfo?.objectId ? 'border-neutral-500 dark:border-neutral-800 dark:border-opacity-50 ' : 'border-red-500 dark:border-red-800'}
            ...
            {featureFlags.actionSets && showActionSetList && !isEnforced && (
              <div className="absolute top-full left-0 right-0 z-50 mt-1 bg-brand-light-bg dark:bg-brand-dark-bg border border-neutral-300 dark:border-neutral-700 rounded-lg shadow-lg">
        ...
        <>
          ...
          <div className="my-4">
            ...
            <input
              ...
              className="w-full p-2 border rounded-lg bg-brand-light-input dark:bg-brand-dark-input dark:border-neutral-600 dark:text-white"
