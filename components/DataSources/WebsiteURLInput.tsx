        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-2 mb-4">
            <div className="flex items-center gap-2">
                <input
                    ...
                    className="flex-grow rounded-lg border border-neutral-500 px-4 py-2 text-neutral-900 shadow focus:outline-none dark:border-neutral-800 dark:border-opacity-50 bg-brand-light-input dark:bg-brand-dark-input dark:text-neutral-100"
                />
                <button
                    type="submit"
                    disabled={loadingSitemap}
                    className="rounded-lg border border-neutral-500 px-4 py-2 text-neutral-900 hover:bg-neutral-100 focus:outline-none dark:border-neutral-800 dark:border-opacity-50 bg-brand-light-input dark:bg-brand-dark-input dark:text-neutral-100 dark:hover:bg-brand-dark-bg disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                >
                        ...
                        <div className="ml-3">
                            <div className="flex items-center gap-2">
                                ...
                                <select
                                    ...
                                    className="rounded-lg border border-neutral-500 px-2 py-1 text-neutral-900 text-sm focus:outline-none dark:border-neutral-800 dark:border-opacity-50 bg-brand-light-input dark:bg-brand-dark-input dark:text-neutral-100"
                                >
                                ...
                                {!unlimitedPages && (
                                    <>
                                        <input
                                            ...
                                            className="w-20 rounded-lg border border-neutral-500 px-2 py-1 text-neutral-900 text-sm focus:outline-none dark:border-neutral-800 dark:border-opacity-50 bg-brand-light-input dark:bg-brand-dark-input dark:text-neutral-100"
                                        />
                      ...
                      <>
                        <div>
                          ...
                          <select
                            ...
                            className="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white bg-brand-light-input dark:bg-brand-dark-input text-gray-900 dark:text-white text-sm"
                          >
