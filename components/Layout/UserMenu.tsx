...
const commonClassname = "group flex w-full items-center gap-3 px-4 py-2 cursor-pointer hover:bg-neutral-100 dark:hover:bg-brand-dark-bg/90 transition-all duration-200";
