...
export const ToggleOptionButtons: React.FC<ToggleButtonGroupProps> = ({ options, selected, onToggle }) => {
    return (
  ...
  const ToggleButton: React.FC<ToggleProps> = ({ id, selected, name, title, icon:Icon, toggleSwitch }) => {
