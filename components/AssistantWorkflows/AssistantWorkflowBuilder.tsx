      ...
      <div className={`mb-4 ${isTerminate ? 'opacity-50' : ''}`}>
        ...
        <div className="flex flex-col">
          <button
            disabled={isTerminate}
            type="button"
            className={`flex flex-row w-full p-2 border text-left rounded-lg bg-white bg-brand-light-input dark:bg-brand-dark-input dark:border-neutral-600 dark:text-white ${ isTerminate ? "" : "hover:bg-gray-50 dark:hover:bg-[#4a4b59] transition-colors"}`}
                ...
                >
                  <div className='flex flex-col w-full'>
                    <ExpansionComponent
                      ...
                      content={<div className=" bg-neutral-100 bg-brand-light-modal dark:bg-brand-dark-modal p-2">{renderStepEditor(step, index)}</div>}
