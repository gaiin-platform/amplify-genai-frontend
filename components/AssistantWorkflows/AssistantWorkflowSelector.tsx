    ...
    return ( 
        ...
        <div className="pr-1">
            ...
            <div className="flex flex-row gap-3">
                <select className={`${workflowTemplates === null || workflowTemplates.length === 0 ? "opacity-40" : ""} mb-2 w-full rounded-lg border border-neutral-500 px-4 py-2 text-neutral-900 shadow focus:outline-none dark:border-neutral-800 dark:border-opacity-50 dark:bg-brand-dark-input dark:text-neutral-100 custom-shadow`} 
