        ...
        return ( <>
                        ...
                        <div className="overflow-y-auto"
                            ...
                            <div className="flex flex-row gap-2 ">
                                <select
                                    className={"my-2 w-full rounded-lg border border-neutral-500 px-4 py-2 text-neutral-900 shadow focus:outline-none dark:border-neutral-800 dark:border-opacity-50 bg-neutral-100 bg-brand-light-input dark:bg-brand-dark-input dark:text-neutral-100 custom-shadow"}
                                ...
                                <button
                                className={`mt-2 px-1 h-[36px] rounded border border-neutral-900 dark:border-neutral-500 px-4 py-2 text-neutral-500 dark:text-neutral-300 bg-brand-light-input dark:bg-brand-dark-input
                           ...
                           {!disableEdit && <>
                            ...
                            {showDataSourceSelector && (
                                <div className="mt-[-8px] flex justify-center overflow-hidden transform scale-y-90 origin-top-left">
                                    <div className="rounded bg-brand-light-bg dark:bg-brand-dark-bg mb-4">
                                    <DataSourceSelector
                                            disallowedFileExtensions={COMMON_DISALLOWED_FILE_EXTENSIONS}
                                            minWidth="500px"
                            ...
                            <ExpansionComponent title={"Advanced"} content={
                                <div className="mb-4 text-black dark:text-neutral-200 mb-6">
                                    ...
                                    <select
                                      ...
                                      className={`mt-2 w-full rounded-lg border border-neutral-500 px-4 py-2 text-neutral-900 shadow focus:outline-none dark:border-neutral-800 dark:border-opacity-50 bg-brand-light-input dark:bg-brand-dark-input dark:text-neutral-100 ${baseWorkflowTemplateId ? "opacity-40" : ""}`}
