...
export const TabSidebar: React.FC<TabSidebarProps> = ({ side, children, footerComponent }) => {
    ...
    return isOpen ? (
        ...
        <div className={`fixed top-0 ${side}-0 flex h-full w-[280px] flex-none ${chatSide()? 'border-r dark:border-r-[#202123]' : 'border-l dark:border-l-[#202123]'}
            flex-col space-y-0 bg-white text-black dark:text-white bg-[#f3f3f3] bg-brand-light-sidebar dark:bg-brand-dark-sidebar text-[14px] sm:relative sm:top-0`} 
            id="sideBar"
            ...
            <div className="relative overflow-hidden">
                ...
                <div className="overflow-auto bg-white bg-brand-light-sidebar dark:bg-brand-dark-sidebar p-0 m-0 flex-grow transition-all duration-300 ease-in-out">
                    <div className="animate-fade-in">
                        {childrenArray[activeTab].props.children}
                    </div>
                </div>
            </div>
            <div className="w-full mt-auto p-2 bg-white bg-brand-light-sidebar dark:bg-brand-dark-sidebar">
                {footerComponent}
            </div>
        </div>
