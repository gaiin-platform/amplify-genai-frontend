...
export const ChatLoader: FC<Props> = () => {
  ...
  return (
    <div
      className="group border-b border-black/10 bg-gray-50 text-gray-800 dark:border-gray-900/50 bg-brand-light-secondary dark:bg-brand-dark-secondary dark:text-gray-100"
