...
const ChatSourceBlock: React.FC<Props> = (
    ...
    return  <div key={index}>
        <div
            className="rounded-xl text-neutral-600 border-2 dark:border-none dark:text-white bg-brand-light-secondary dark:bg-brand-dark-bg rounded-md shadow-lg mb-2 mr-2"
        >
