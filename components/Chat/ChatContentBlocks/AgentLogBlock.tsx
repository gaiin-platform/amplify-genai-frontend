...
const getAgentLogItem = (msg: any) => {
  if (msg.role === 'assistant' && msg.content && msg.content.tool === 'exec_code') {
    return (
      <div className="flex items-center gap-2 bg-gray-50 bg-brand-light-secondary dark:bg-brand-dark-secondary rounded p-2 my-1 max-w-full">
    ...
    return (
      <div className="flex flex-col gap-2 bg-gray-50 bg-brand-light-secondary dark:bg-brand-dark-secondary rounded p-2 my-1">
    ...
    return (
      <div className="flex items-center gap-2 bg-brand-light-bg dark:bg-brand-dark-bg rounded p-2 my-1 mr-2">
    ...
    if (msg.content?.total_token_cost) {
      return (
      <div className="mt-4 flex items-center gap-2 bg-brand-light-bg dark:bg-brand-dark-bg rounded p-2 my-1 mr-2">
    ...
    return (
      <div className="flex items-center gap-2 bg-gray-50 bg-brand-light-secondary dark:bg-brand-dark-secondary rounded p-2 my-1">
        <IconTerminal2 className="min-w-[20px] text-blue-600 dark:text-blue-400" />
        <div className="w-full overflow-x-auto">
          <div className="flex items-center gap-2 mb-1">
            {hasError ? (
