...
const getArtifactMessages = async (llmInstructions: string, artifactDetail: ArtifactBlockDetail, type: string = '', messageKey?: string, cooldownKey?: string) => {
    ...
    return <div className="flex flex-col gap-4 ">           
            <div className="flex flex-row gap-3 rounded-xl text-neutral-600 border-2 dark:border-none dark:text-white bg-brand-light-secondary dark:bg-brand-dark-bg rounded-md shadow-lg p-1 pl-2">
                <IconHammer size={20}/>
