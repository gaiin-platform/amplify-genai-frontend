            ...
            <div className="flex flex-col justify-center items-center stretch mx-2 flex flex-row gap-3 last:mb-2 md:mx-4 md:last:mb-6 lg:mx-auto lg:max-w-3xl">
                {featureFlags.memory && settingRef.current?.featureOptions.includeMemory && selectedConversation && selectedConversation.messages?.length > 0 && extractedFacts.length > 0 && (
                    <div className="w-full">
                        {isFactsVisible && (
                            <div className="text-black dark:text-white extracted-facts bg-brand-light-bg dark:bg-brand-dark-bg rounded-lg shadow-lg flex flex-col">
                                <div className="relative max-h-96 overflow-y-auto pt-0.5">
                                    <table className="w-full border-collapse">
                                        <thead>
                                            <tr>
                                                <th className="sticky -top-1 border border-gray-200 dark:border-gray-600 px-4 py-2 text-left bg-brand-light-bg dark:bg-brand-dark-bg z-10">Fact</th>
                                                <th className="sticky -top-1 border border-gray-200 dark:border-gray-600 px-4 py-2 text-center w-32 bg-brand-light-bg dark:bg-brand-dark-bg z-10">Actions</th>
                                            </tr>
                                        </thead>
