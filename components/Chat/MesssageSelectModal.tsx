...
const MessageSelectModal: React.FC<Props> = ({setConversation, onSubmit, onCancel}) => {
    ...
    <div className="fixed inset-0 z-10 overflow-hidden">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
          <div className="dark:border-netural-400 inline-block overflow-hidden rounded-lg border border-gray-300 bg-white px-4 pt-5 text-left align-bottom shadow-xl transition-all dark:bg-[#202123] sm:my-8 sm:w-full sm:max-w-[600px] sm:align-middle "
           style={{ transform: 'translateY(+26%)', position: 'relative' }}>
            ...
            <div className="flex flex-row items-center justify-end py-4 bg-white dark:bg-[#202123]">
