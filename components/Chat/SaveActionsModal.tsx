...
export const SaveActionsModal: FC<SaveActionsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white bg-brand-light-modal dark:bg-brand-dark-modal text-black dark:text-neutral-200 rounded-lg border border-gray-300 dark:border-neutral-600 shadow-xl" style={{ width }}>
        ...
        <div className="p-6">
          <div className="mb-4">
            ...
            <input
              id="name"
              type="text"
              className={`w-full rounded-lg border ${nameError ? 'border-red-500' : 'border-neutral-500'} px-4 py-2 shadow bg-brand-light-input dark:bg-brand-dark-input dark:text-neutral-100`}
