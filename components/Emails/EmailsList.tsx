        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div className="fixed inset-0 z-10 overflow-hidden">
                <div className="flex items-center justify-center min-h-screen pt-4 pb-20 text-center sm:block sm:p-0">
                    <div className="inline-block overflow-y-auto  overflow-x-hidden rounded-lg border border-gray-300 bg-white px-4 pt-5 text-left align-bottom shadow-xl transition-all bg-brand-light-modal dark:bg-brand-dark-modal sm:my-8 sm:w-full sm:max-w-[480px] sm:align-middle"
                        ...
                        <div className="max-h-[calc(100vh-10rem)] p-0.5 overflow-y-auto">
                            ...
                            <div className="mt-2 flex flex-row items-center justify-end p-4 bg-white bg-brand-light-modal dark:bg-brand-dark-modal">
                                <button
                                    type="button"
