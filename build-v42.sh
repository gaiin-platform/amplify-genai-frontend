...
echo "Building amplify-frontend:v42 - JWT Fix with getServerSession"
echo "============================================================="
...
docker build --platform linux/amd64 \
  ...
  --build-arg NEXT_PUBLIC_APP_VERSION=1.0.42 \
  -t amplify-frontend:v42 .

echo "✅ Build complete!"

# Tag and push
docker tag amplify-frontend:v42 \
  135808927724.dkr.ecr.us-east-1.amazonaws.com/dev-amplifygenai-repo:v42

echo "Pushing to ECR..."
docker push 135808927724.dkr.ecr.us-east-1.amazonaws.com/dev-amplifygenai-repo:v42
