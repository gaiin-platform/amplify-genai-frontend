...
echo "Building Amplify Frontend v15 - Critical Fixes"
echo "- Fixed TypeScript error in test-sse.tsx"
echo "- SSE undefined content handling from v14"
echo "- DNS now points to correct ALB"
echo ""
...
docker build \
  ...
  -t amplify-frontend:v15-critical-fixes \
  -f Dockerfile.standalone \
  .

echo ""
echo "Build complete! Tagged as v15-critical-fixes"
echo ""
echo "Next steps:"
echo "1. Tag for ECR:"
echo "   docker tag amplify-frontend:v15-critical-fixes 135808927724.dkr.ecr.us-east-1.amazonaws.com/dev-amplifygenai-repo:v15-critical-fixes"
echo ""
echo "2. Push to ECR:"
echo "   docker push 135808927724.dkr.ecr.us-east-1.amazonaws.com/dev-amplifygenai-repo:v15-critical-fixes"
echo ""
